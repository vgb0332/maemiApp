...
export default class PhotoUpload extends React.Component {
  static propTypes = {
    ...
    promptOptions: PropTypes.object,
  }
  ...
  options = {
    title: this.props.promptOptions.title || 'Select a Photo',
    cancelButtonTitle: this.props.promptOptions.cancelButtonTitle || 'Cancel',
    takePhotoButtonTitle: this.props.promptOptions.takePhotoButtonTitle || 'Take Photo…',
    chooseFromLibraryButtonTitle: this.props.promptOptions.chooseFromLibraryButtonTitle || 'Choose from Library…',
